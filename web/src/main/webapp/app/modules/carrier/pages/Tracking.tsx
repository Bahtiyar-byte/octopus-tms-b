...
const Tracking: React.FC = () => {
  ...
  const MapCenterControl = ({ coordinates }: { coordinates: LatLng }) => {
    const map = useMap();

    useEffect(() => {
      map.setView([coordinates.lat, coordinates.lng], 8);
    }, [map, coordinates]);
    ...
    <div className="fade-in">
      ...
      <Card className="mb-8 shadow-md overflow-hidden">
        <div className="relative h-96 w-full">
          <MapContainer 
            center={[selectedShipment.coordinates.current.lat, selectedShipment.coordinates.current.lng]} 
            zoom={8} 
          ...
          >
            ...
            <MapCenterControl coordinates={selectedShipment.coordinates.current} />
