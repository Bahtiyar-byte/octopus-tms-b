...
const Tracking: React.FC = () => {
  ...
  const notifications = [
    { id: '1', time: '10:45 AM', loadId: 'LD1003', type: 'location_update', message: 'Truck arrived in Macon, GA' },
    { id: '2', time: '09:30 AM', loadId: 'LD1006', type: 'delay_alert', message: 'Truck delayed due to traffic on I-5. ETA pushed by 45 min.' },
    { id: '3', time: '08:15 AM', loadId: 'LD1007', type: 'status_change', message: 'Shipment entering final delivery zone. Arriving soon.' },
    { id: '4', time: 'Yesterday', loadId: 'LD1002', type: 'weather_alert', message: 'Heavy rain expected along route. Driver notified.' }
  ];
  ...
  const timelineEvents: Record<string, TimelineEvent[]> = {
    ...
    '2': [
      { id: '1', title: 'Departed Origin', timestamp: 'May 22, 2025 - 09:30', location: 'San Francisco, CA', status: 'completed' },
      ...
      { id: '4', title: 'Expected Arrival', timestamp: 'May 25, 2025 - 10:15', location: 'Los Angeles, CA', status: 'upcoming' }
    ],
    '3': [
      { id: '1', title: 'Departed Origin', timestamp: 'May 21, 2025 - 07:30', location: 'Denver, CO', status: 'completed' },
      ...
      { id: '4', title: 'Expected Arrival', timestamp: 'May 23, 2025 - 16:45', location: 'Phoenix, AZ', status: 'upcoming' }
    ],
    '4': [
      { id: '1', title: 'Departed Origin', timestamp: 'May 23, 2025 - 10:00', location: 'Dallas, TX', status: 'completed' },
      { id: '2', title: 'Current Location', timestamp: 'May 23, 2025 - 11:45', location: 'Corsicana, TX', status: 'current' },
      { id: '3', title: 'Expected Arrival', timestamp: 'May 23, 2025 - 18:30', location: 'Houston, TX', status: 'upcoming' }
    ],
    '5': [
      { id: '1', title: 'Departed Origin', timestamp: 'May 23, 2025 - 06:00', location: 'Chicago, IL', status: 'completed' },
      { id: '2', title: 'Current Location', timestamp: 'May 23, 2025 - 12:00', location: 'Kalamazoo, MI', status: 'current' },
      { id: '3', title: 'Expected Arrival', timestamp: 'May 24, 2025 - 09:00', location: 'Detroit, MI', status: 'upcoming' }
    ],
    '6': [
      { id: '1', title: 'Departed Origin', timestamp: 'May 23, 2025 - 08:00', location: 'Seattle, WA', status: 'completed' },
      { id: '2', title: 'Current Location', timestamp: 'May 23, 2025 - 12:30', location: 'Olympia, WA', status: 'current' },
      { id: '3', title: 'Expected Arrival', timestamp: 'May 23, 2025 - 15:00', location: 'Portland, OR', status: 'upcoming' }
    ]
  };
